...
```sh
curl -LO https://github.com/aloisdeniel/omafiles/releases/latest/download/omafiles-0.0.2-1-x86_64.pkg.tar.zst
sudo pacman -U omafiles-0.0.2-1-x86_64.pkg.tar.zst
```
